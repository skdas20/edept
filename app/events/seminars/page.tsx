                    ...
                    <div className="bg-white rounded-3xl shadow-lg p-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {seminarImages.map((image, index) => (
                                <div key={index} className="relative aspect-video rounded-xl overflow-hidden cursor-pointer group shadow-md hover:shadow-xl transition-all" onClick={() => setSelectedImage(image)}>
                                    <Image src={image} alt={`Seminar ${index + 1}`} fill className="object-cover transition-transform duration-300 group-hover:scale-105" />
